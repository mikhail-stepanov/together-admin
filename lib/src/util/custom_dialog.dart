      ...
      child: MediaQuery.removeViewInsets(
        ...
        child: Center(
          child: ConstrainedBox(
            constraints: const BoxConstraints(minWidth: 1100.0),
            child: Material(
...
///  * [CustomDialog], on which [CustomAlertDialog] and [SimpleDialog] are based.
///  * [showDialog], which actually displays the dialog and returns its result.
...
///  * [CustomDialog], on which [SimpleDialog] and [CustomAlertDialog] are based.
///  * [showDialog], which actually displays the dialog and returns its result.
///  * <https://material.google.com/components/dialogs.html#dialogs-simple-dialogs>
